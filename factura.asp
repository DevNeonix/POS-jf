...
<style type="text/css">
body { font-family:Century Gothic; font-size:10px; color:Black; padding-left:14px; padding-top:140px; width:750px}
body2 { font-family:Century Gothic; font-size:11px;  color:Black; padding-left:14px; padding-top:140px;  }
</style>
...
<tr>
<td>
	<table border="0"   align="left" cellpadding="0"cellspacing="0" WIDTH="740px">
    	<%do while not rs.eof %>
      	<tr  valign="bottom">
        	<td width="50px" align="left"><%=UCASE(left(trim(RS("codart")),10)) %></td>
        	<td width="30px" align="right"><%=RS("SALE") %>&nbsp;</td>
        	<td width="400px" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=TRIM(RS("UNI"))%>&nbsp;&nbsp;&nbsp;&nbsp; <%=left(trim(RS("DESCRI")),62) %></td>
    	...
    	<%next %>
		<% if  tienda="16" then %>
                    <tr><td colspan="7" style="font-size:10px"><center>No se acepta cambios ni devoluciones.</center></td></tr>
                        <%else%>
                        <tr><td colspan="7" style="font-size:10px"><center>No se acepta cambios ni devoluciones en ropa interior ni prendas con descuento, pijamas sólo cambios con documento de vta., máx 7 dias.
                        </center></td></tr>
                    <% end if %>
	</table>
</td>
...
<td>
    ...
    <tr  valign="bottom" height="30px" >
        <td width="14px">&nbsp;</td>
        <td id="sonn" style="font-weight:800;font-size:12px"></td>
    </tr>
	</table>
</td>
</tr>
...
<td>
    ...
    <tr  valign="bottom" height="13px">
        <td align="right">S/.</td>
        <td align="right" ><%=formatnumber(IGV,2)%>&nbsp;</td>
    </tr>
     <tr  valign="bottom" height="13px">
        <td align="right">ISC S/.</td>
        <td align="right" ><%=formatnumber(ISC,2)%>&nbsp;</td>
    </tr>
    <tr  valign="bottom" height="13px">
        <td align="right" >S/.</td>

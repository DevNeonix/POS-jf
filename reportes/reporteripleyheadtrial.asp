...
<table id="Table1" align="center"  bordercolor="#FFFFFF"  bgcolor="<%=Application("color2")%>"  cellpadding="2"  cellspacing="4"  border="0">
	<tr><td style="text-align: center;">Reporte Trial</td></tr>
    <tr valign="middle" >
...
<script type="text/javascript">
	...
	function MUESTRA(){
		...
		var cad = './reporteripleydetatrial.asp?ini='+iInicio+'&fin='+iFinal;
	...
	function excel(){
		...
		iInicio = document.getElementById("inicio").value;
		iFinal = document.getElementById("final").value;
		var cad = './reporteripleydetatrial.asp?ini='+iInicio+'&fin='+iFinal+'&excel=1'
		window.open(cad)
	}
</script>
</body>

...
function graba() {
    ...
    // Datos para grabar cabecera y detalle
        ...
        cad += '&DES=' + toAlpha(ltrim(rtrim(document.all.DES.value)))
        cad += '&sol=' + toInt(ltrim(rtrim(document.all.SOL.value)))
        cad += '&d1=' + ltrim(rtrim(document.all.DOC.value))
        cad += '&s1=' + ltrim(rtrim(document.all.SER.value))
        cad += '&N1=' + ltrim(rtrim(document.all.NRO.value))
